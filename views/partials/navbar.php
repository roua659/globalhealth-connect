    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center">
                <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>?page=frontoffice">FrontOffice</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>?page=publications">Forum</a></li>
                <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>?page=moderation">Moderation IA</a></li>
