...
class DossierMedicalModel {
    ...
    public $diagnostic;
    public $traitement;
    public $ordonnance_texte;
    public $ordonnance_fichier;
    ...
    public function create() {
        ...
        $this->historique_modification = "Cree le " . $this->date_creation;
        ...
        $query = "INSERT INTO " . $this->table_name . " 
                  SET id_patient=:id_patient, id_medecin=:id_medecin, id_rdv=:id_rdv,
                      ...
                      ordonnance_texte=:ordonnance_texte, ordonnance_fichier=:ordonnance_fichier,
        ...
        $stmt->bindParam(":ordonnance_texte", $this->ordonnance_texte);
        $stmt->bindParam(":ordonnance_fichier", $this->ordonnance_fichier);
    ...
    public function update() {
        $existingDossier = $this->readOne();
        $history = $existingDossier['historique_modification'] ?? '';
        $this->historique_modification = date('Y-m-d H:i:s') . " - Modifie\n" . $history;
