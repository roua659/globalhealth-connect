...
final class MailService
{
    public static function sendPatientNotification(array $notification): array
    {
        ...
        if (!filter_var($to, FILTER_VALIDATE_EMAIL)) {
            return [
                'success' => false,
                'error' => 'Email patient invalide ou manquant',
            ];
        }
        ...
        $subject = 'Notification GlobalHealth Connect';
        $body = "Bonjour {$patientName},\n\n"
            . $message . "\n\n"
            . "Cordialement,\nGlobalHealth Connect";

        return self::sendConfiguredMail($to, $subject, $body);
    }
    ...
    public static function sendReviewNotification(array $review): array
    {
        ...
        if (!filter_var($to, FILTER_VALIDATE_EMAIL)) {
            return [
                'success' => false,
                'error' => 'Email medecin invalide ou manquant',
            ];
        }
        ...
        $subject = 'Nouvel avis patient - GlobalHealth Connect';
    ...
    private static function sendConfiguredMail(string $to, string $subject, string $body): array
    {
        ...
        try {
            ...
            return [
                'success' => false,
                'error' => 'Envoi SMTP Gmail echoue: ' . $e->getMessage(),
            ];
        }
    }
